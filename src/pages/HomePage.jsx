...
import { posts, idrisFeedPosts } from '../data/mockData.js'
...
export default function HomePage() {
  ...
  // Place IdrisVideo1 as the 5th item in the For you feed
  const combined =
    tab === 'foryou'
      ? [...createdPosts, ...feedPosts.slice(0, 4), ...idrisFeedPosts, ...feedPosts.slice(4)]
      : feedPosts
